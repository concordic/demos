...
pub extern fn initWindow(width: c_int, height: c_int, name: [*c]const u8) ?*GLFWwindow;
pub extern fn updateWindow(window: ?*GLFWwindow, loop: ?*const fn (...) callconv(.c) c_int) void;
pub extern fn deinitWindow(window: ?*GLFWwindow) void;
...
// /opt/homebrew/Cellar/zig/0.14.0_1/lib/zig/include/__stddef_offsetof.h:16:9
